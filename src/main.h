...
static const int64 DUST_SOFT_LIMIT = 0.0000001 * COIN; // 0.0000001 KSC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 0.00000001 * COIN; // 0.00000001 KSC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 1001 * COIN;
